...
<html>
  ...
  <body>   
    <!-- <form action="">
  	...
  	下载文件：<a href="downloadServlet.do?filename=test1.txt">test.txt</a> &nbsp;&nbsp; ${errorResult}
  	下载图片1：<a href="downloadServlet.do?filename=img1-lg.jpg">img1-lg.jpg</a> &nbsp;&nbsp; ${errorResult}
  	<div id="large"></div>
  	<hr>
    <h2>图片预览</h2>
